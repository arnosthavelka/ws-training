...
public class JaxwsEndpoint {
    ...
    // }
    //
    // @WebService(serviceName = "CalcService", portName = "CalcPort", endpointInterface =
    // "com.asseco.aha.training.ws.calc.srv.v1.CalcPortType")
    ...
    //
    // @Override
    // public AddResponse multiply(AddRequest arg0) {
